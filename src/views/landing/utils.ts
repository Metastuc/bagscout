export function computeDataMode(
  attributes?: GeckoPoolAttributes | null,
): GeckoDataMode {
  ...
  const [hasVolume, hasTransactions] = [
    ...
    Number(attributes.transactions.h24.buys ?? 0) +
      Number(attributes.transactions.h24.sells ?? 0) >
      0,
  ];
...
export function displaySafeValue(
  number: number | null,
